...
export class CheckinService {
  ...
  userCollection = this.firestore.collection<UserInfo>('user', (ref) => {
  ...
  test() {
    ...
    // const a = this.userCollection.doc('gdZ5zp6IWw1LWMMKuRrt').collection('checkins').valueChanges().subscribe(e=>{
    //   console.log('aaa')
    //   console.log(e)
    // })
    ...
    this.userCollection.doc(this.userService.userId$.value).collection('checkins').doc('210626').set(data).then(e=>{
      console.log('aaa')
      console.log(e)
    })
    // this.userCollection.doc(this.userService.userId$.value).collection()
    this.userCollection.valueChanges().subscribe((e) => {
      console.log(e);
    });
    // this.checkinCollection.doc('ZT2wMof79ieAgJHTpctd').update({content:'0625'}).then(e=>{
    //   console.log('更新囉')
    // })
  }
  ...
  addCheckin(checkinObj: any): Observable<any> {
    ...
    // this.userCollection.doc(this.userService.userId$.value).collection('checkins').add(data).then((e) => {
    //   console.log(e);
